...
/***/ function(module, exports, __webpack_require__) {
	...
	var node = document.querySelector('[data-react-class]');

	if (node) {
	  var reactClass = node.dataset.reactClass;
	  var reactType = node.dataset.reactType;
	  var Component = __webpack_require__(190)("./" + reactClass).default;

	  if (reactType === 'plain') {
	    _reactDom2.default.render(_react2.default.createElement(Component, JSON.parse(node.dataset.reactProps)), node);
	  } else {
	    var reducers = __webpack_require__(316)("./" + reactClass).default;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SurveysList = __webpack_require__(194);
	...
	var SurveysApp = function (_Component) {
	  _inherits(SurveysApp, _Component);

	  function SurveysApp() {
	    _classCallCheck(this, SurveysApp);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(SurveysApp).apply(this, arguments));
	  }
	...
	function mapDispatchToProps(dispatch) {
	  return {
	    actions: (0, _redux.bindActionCreators)(_actions.surveysActions, dispatch)
	  };
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _sortBy = __webpack_require__(195);
	...
	var SurveysList = function (_Component) {
	  _inherits(SurveysList, _Component);

	  function SurveysList(props) {
	    _classCallCheck(this, SurveysList);

	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(SurveysList).call(this, props));
	  ...
	  _createClass(SurveysList, [{
	    ...
	    key: 'renderSurvey',
	    value: function renderSurvey(survey) {
	      return _react2.default.createElement(
	        'li',
	        { key: survey.id },
	        _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'a',
	          { href: '', onClick: this.handleEdit.bind(this, survey.id) },
	          'Edit'
	        ),
	        _react2.default.createElement(
	          'span',
	        ...
	        _react2.default.createElement(
	          'a',
	          { href: '', onClick: this.handleDestroy.bind(this, survey.id) },
	          'Destroy'
	        )
	      );
	    }
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          (0, _sortBy2.default)(surveys, function (survey) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isFunction = __webpack_require__(204),
	    ...
	    toSource = __webpack_require__(238);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(global) {var checkGlobal = __webpack_require__(237);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _surveys = __webpack_require__(318);
