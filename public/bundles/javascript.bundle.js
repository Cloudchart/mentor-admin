...
/***/ function(module, exports, __webpack_require__) {
	...
	if (node) {
	  ...
	  var Component = !(function webpackMissingModule() { var e = new Error("Cannot find module \"./containers\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()).default;

	  if (reactType === 'plain') {
	    _reactDom2.default.render(_react2.default.createElement(Component, JSON.parse(node.dataset.reactProps)), node);
	  } else {
	    var reducers = !(function webpackMissingModule() { var e = new Error("Cannot find module \"./reducers\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()).default;
